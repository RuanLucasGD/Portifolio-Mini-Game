...
{
    /// <summary>
    /// Window on the asset that appears in the editor's main menu bar
    /// </summary>
    public class MMV_Editor : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            {
                Process.Start("https://www.youtube.com/watch?v=-BVTLdE3tH0&list=PLHpkt9fDv8d8N3xUk_dTgQSnpcTYzsMXs");
            }
